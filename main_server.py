...
def main():
    ...
    server = ServerApp(port=args.port, sensitivity=args.sensitivity, scale_to_snap=args.scale_to_snap, hide_mouse=args.hide_mouse, compress_images=args.compress_images)
    server.start()
