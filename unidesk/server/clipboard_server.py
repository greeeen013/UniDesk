...
class ClipboardServer:
    ...
    def _message_loop(self) -> None:
        ...
        # HWND and other handles are pointer-sized (8 bytes on x64)
        ...
        # argtypes set later due to WNDCLASSEX dependency
        ...
        if not user32.RegisterClassExW(ctypes.byref(wc)):
            # If class already exists, that's fine for multiple runs in one process
            pass
